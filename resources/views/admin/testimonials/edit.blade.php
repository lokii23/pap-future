...
<body class="bg-gray-100 flex min-h-screen">
    ...
    <aside class="w-64 bg-white shadow-lg p-4 flex flex-col">
        ...
        <nav class="flex-1 space-y-2">
            ...
            <a href="{{ route('testimonials.index') }}" class="block px-4 py-2 rounded text-white {{ request()->routeIs('testimonials.edit') ? 'bg-red-600 font-semibold' : '' }}">
                Testimonials
            </a>
    ...
    <main class="flex-1 p-6">
        ...
        <div class="container">
            ...
            <form action="{{ route('testimonials.update', $testimonial) }}" method="POST" enctype="multipart/form-data">
                ...
                @include('admin.testimonials.form', ['button' => 'Update'])
            </form>
        </div>
    </main>
